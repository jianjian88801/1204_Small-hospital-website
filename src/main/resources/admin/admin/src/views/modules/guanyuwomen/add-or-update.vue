<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医院邮箱" prop="yiyuanyouxiang">
          <el-input v-model="ruleForm.yiyuanyouxiang" 
              placeholder="医院邮箱" clearable  :readonly="ro.yiyuanyouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医院邮箱" prop="yiyuanyouxiang">
              <el-input v-model="ruleForm.yiyuanyouxiang" 
                placeholder="医院邮箱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="医院简介" prop="yiyuanjianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yiyuanjianjie" label="医院简介" prop="yiyuanjianjie">
                    <span>{{ruleForm.yiyuanjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='yiyuanyouxiang'){
            this.ruleForm.yiyuanyouxiang = obj[o];
	    this.ro.yiyuanyouxiang = true;
            continue;
          }
          if(o=='xiangqing'){
